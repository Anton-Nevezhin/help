...
TELEGRAM_BOT_TOKEN=ваш_токен
TELEGRAM_BOT_NAME=имя_бота
5.	Пользователи добавляют свой Telegram ID в личном кабинете. Узнать свой ID можно у бота @userinfobot.
________________________________________
Настройка Email
...
1.	Сайт мгновенно сохраняет мероприятие и показывает страницу «Успешно».
2.	Задачи на отправку уведомлений попадают в очередь.
3.	Фоновый процесс (php artisan queue:work) обрабатывает задачи и отправляет сообщения.
...
1.	Запустите OpenServer (или любой другой локальный сервер).
2.	Создайте базу данных help.
3.	Выполните миграции и сидеры.
4.	Создайте администратора.
5.	Запустите очередь.
6.	Запустите php artisan serve.
